...
WeMR internships are by design completely online, which leads to it's own sets of challenges, hence the need for this discussion.
In general, mentors might feel that the students would have performed better or been more disciplined if the projects were offline.
Some mentors have had students not responding for a month or so after the initial meeting, especially during their exam months. Sometimes, students don't have clarity regarding what is expected from them and by when, or mentors may have more than realistic expectations from the project. 
...
How does one ensure that meeting times and deadlines are reasonable as well as respected in a remote setting?
Having a default frequency for the meeting helps the most, e.g. say a voice/video call every weekend.
